...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    # session-bus plugin (unified; replaces session-bridge + session-routing)
    # -- six tools, all gated by `check_fn` until the NATS broker is reachable.
    "tool.session_bus": ("nats-py==2.15.0",),
}
