...
# install from a pinned fork without maintaining a divergent copy of this script.
...
# otherwise the SSH-first clone would still hit the default repo before fallback.
