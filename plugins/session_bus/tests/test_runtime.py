...
from plugins.session_bus.runtime import (
...
class StartStop(unittest.TestCase):
    ...
    def _patches(self):
        ...
        return (
            patch(
                "plugins.session_bus.runtime.InboxRunner", FakeInboxRunner
            ),
            patch(
                "plugins.session_bus.presence.update_presence",
...
class ThreadsafeNotification(unittest.TestCase):
    ...
    def test_no_gateway_returns_false(self):
        from plugins.session_bus import runtime as runtime_mod
...
class SessionFinalize(unittest.TestCase):
    def test_finalize_closes_channels_for_session(self):
        ...
        async def _go():
            with patch(
                "plugins.session_bus.channels.close_channels_for_session",
                fake_close,
            ), patch.dict(
