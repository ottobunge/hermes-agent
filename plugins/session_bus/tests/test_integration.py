"""Integration tests for plugins.session_bus — broker round-trip.
...
Run via the venv that has nats-py installed:
    ...
    .venv/bin/python3 -m unittest \
        plugins.session_bus.tests.test_integration -v
"""
...
from plugins.session_bus import address, presence, routing
...
class TestBackChannelRoundTrip(unittest.TestCase):
    ...
    async def _run(self):
        ...
        kv_keys_to_cleanup = []
        try:
            # ── A initiates (exactly what bus_establish publishes) ──
